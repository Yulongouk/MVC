<%@page import="DBOperation.Students"%>
            ...
            <div class="view-all-form-wrapper">
                ...
                <div class="view-all-form-popup move-horizontal" id="myViewAllForm">
                    <form id="form2" class="form-container">
                        ...
                        <hr style="color:#e55743;">
<!--                        <label for="id"><b>ID</b></label><br>
-->                     <input type="hidden" name="operation" value="viewAll"/><!--
                        <input type="text" placeholder="Enter ID" name="id" required>-->
                        <button onclick="javascript:document.getElementById('form2').submit()" class="btn">View All</button>
                    </form>
                </div>
            </div>
                ...
                <%
                    ...
                    if(oper != null) {
                        if(oper.equals("insert")) {
                            ...
                            student.setId(id);
                            student.setName(name);
                            dop.UpdateRecord(student);
                            response.sendRedirect("dashboard.jsp");
                        } else if (oper.equals("delete")) {
                            id = Integer.parseInt(request.getParameter("id"));
                            student.setId(id);
                            dop.DeleteRecord(student);
                            response.sendRedirect("dashboard.jsp");
